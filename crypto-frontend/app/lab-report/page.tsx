      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        <div className="grid gap-8">
          <div className="rounded-3xl border border-[var(--card-border)] bg-[var(--card)] p-6 shadow-sm">
            <div className="flex flex-col gap-6">
              <div>
                ...
                <p className="max-w-5xl leading-7 text-[var(--muted)]">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-cyan-400/40 bg-cyan-400/10 px-5 py-3 text-sm font-semibold text-cyan-600 transition hover:bg-cyan-400/20 dark:text-cyan-200"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-[var(--card-border)] px-5 py-3 text-sm font-semibold text-[var(--muted)] transition hover:border-cyan-400/40 hover:text-cyan-600 dark:hover:text-cyan-200"
                >
                  <ExternalLink className="h-4 w-4" />
                  GitHub Source
                </a>
          ...
          <div className="overflow-hidden rounded-3xl border border-[var(--card-border)] bg-[var(--card)] shadow-sm">
            ...
            >
              <iframe
                src={`${localPdfUrl}#toolbar=1&navpanes=0&scrollbar=1&zoom=100`}
